...
import com.bsw.common.utils.CommonUtils;
import com.bsw.common.utils.SPUtils;
    ...
    <T> void reflectPrimaryKey(T t) {
        ...
        for (Field field : fields) {
            ...
            if (primaryKeyAnno) {                                   // 主键
                ...
                try {
                    primaryKeyPojo = new ColumnPojo(field, name, CommonUtils.isEmpty(t) ? null : field.get(t), type, true);
                    break;
    ...
    private <T> void reflect(Class clz, T t) {
        ...
        for (Field field : fields) {
            ...
            if (requireAnno) {                                      // 必填项
                ...
                try {
                    ColumnPojo columnPojo = new ColumnPojo(field, name, CommonUtils.isEmpty(t) ? null : field.get(t), type, true);
