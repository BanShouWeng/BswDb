...
public class DbManager {
    ...
    public void mDelete(String tableName, String whereClause, String[] whereArgs) {
        ...
        logger.e(getName(), "已清空" + tableName + "表".equals(whereClause));
        closeAll();
    }
    ...
    public void mDropTable(String tableName) {
        ...
        logger.e(getName(), "已删除" + tableName + "表");
        closeAll();
    }
    ...
    public void mDeleteTable(String tableName) {
        ...
        logger.e(getName(), "已清空" + tableName + "表");
        closeAll();
    }
    ...
    boolean isTableExist(String tableName) {
        ...
        try {
            ...
            logger.e(getName(), tableName + "表不存在");
        }
        if (mCursor != null && ! mCursor.isClosed()) {
            mCursor.close();
        } else {
            logger.e(getName(), "closeAll: mCursor已关闭");
        }
        closeAll();
        return result;
    }
    ...
    class SqlMaker {
        ...
        SqlMaker() {
            ...
            logger.i(getClass().getSimpleName(), mSqlBuffer.toString());
        }
        ...
        String getSql() {
            ...
            if (mSqlBuffer.length() > 0) {
                ...
                sql = "(" + sql + ")";
                logger.i(getClass().getSimpleName(), sql);
                mSqlBuffer = new StringBuffer();
                isSqlSuccessed = true;
            }
            return sql;
